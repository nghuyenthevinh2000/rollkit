...
func (_m *Store) GetBtcRollupsProofs(ctx context.Context, height uint64) (*btctypes.RollUpsBlock, error) {
	ret := _m.Called(ctx, height)

	if len(ret) == 0 {
		panic("no return value specified for GetBtcRollupsProofs")
	}

	var r0 *btctypes.RollUpsBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*btctypes.RollUpsBlock, error)); ok {
		return rf(ctx, height)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) *btctypes.RollUpsBlock); ok {
		r0 = rf(ctx, height)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*btctypes.RollUpsBlock)
		}
	}
...
func (_m *Store) SetBtcRollupsProofs(ctx context.Context, proofs *btctypes.RollUpsBlock) error {
	ret := _m.Called(ctx, proofs)

	if len(ret) == 0 {
		panic("no return value specified for SetBtcRollupsProofs")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *btctypes.RollUpsBlock) error); ok {
		r0 = rf(ctx, proofs)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) BtcRollupsProofsHeight() uint64 {
	ret := _m.Called()
...
func (_m *Store) SetBtcRollupsProofsHeight(ctx context.Context, height uint64) {
	ret := _m.Called(ctx, height)
